...
class CliPrinter(): Printer {
    ...
    override fun playerAlreadyExists(playerName: String): String = "$playerName: already existing player"

    override fun players(names: List<String>): String = "players: " + names.joinToString(", ")

    override fun notFound(): String = "Error: command not found"
